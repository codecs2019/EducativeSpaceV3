<%@ Page Title="" Language="C#" MasterPageFile="~/StartRoot.master" AutoEventWireup="true"
    CodeFile="FormJournalConnexion.aspx.cs" Inherits="Web_FormJournalConnexion" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="PageContent" runat="Server">
    <dx:ASPxGridView ID="MainGridView" runat="server" AutoGenerateColumns="False" KeyFieldName="ID_PROFILCONNECT"
        OnRowDeleting="Delete" onhtmlrowprepared="ASPxGridView2_HtmlRowPrepared"
        Width="100%" ClientInstanceName="gridView">
        <SettingsText PopupEditFormCaption="Journal de connexion" />
        ...
        <Columns>
            <dx:GridViewDataTextColumn FieldName="ID_PROFILCONNECT" 
                                            VisibleIndex="0" Caption="Id" visible = "false">
                                        </dx:GridViewDataTextColumn>

                                        <dx:GridViewDataTextColumn FieldName="LOGIN"
                                            VisibleIndex="1" Caption="Login" >
                                        </dx:GridViewDataTextColumn>

                                        <dx:GridViewDataTextColumn FieldName="USERNOM"
                                            VisibleIndex="1" Caption="Nom" >
                                        </dx:GridViewDataTextColumn>

                                        <dx:GridViewDataTextColumn FieldName="USERPRENOM"
                                            VisibleIndex="1" Caption="Prénoms" >
                                        </dx:GridViewDataTextColumn>
                                        
                                        <dx:GridViewDataTextColumn Caption="Profil" FieldName="ROLE" 
                                            VisibleIndex="2">
                                        </dx:GridViewDataTextColumn>

                                        <dx:GridViewDataDateColumn FieldName="DATESESSION" VisibleIndex="3" width = "50px"
                                        Caption="Date de connexion">
                                        </dx:GridViewDataDateColumn>

                                        <dx:GridViewDataTimeEditColumn FieldName="DATESESSION" VisibleIndex="4" width = "50px"
                                        Caption="Heure D">
                                        </dx:GridViewDataTimeEditColumn>

                                        <dx:GridViewDataDateColumn FieldName="DATEFINSESSION" VisibleIndex="5" width = "50px"
                                        Caption="Date fin connexion" >
                                        </dx:GridViewDataDateColumn>

                                        <dx:GridViewDataTimeEditColumn FieldName="DATEFINSESSION" VisibleIndex="6" width = "50px"
                                        Caption="Heure F">
                                        </dx:GridViewDataTimeEditColumn>
                                        
                                        <dx:GridViewDataTextColumn Caption="Adresse IP" FieldName="ADRESSEID" 
                                            VisibleIndex="7">
                                        </dx:GridViewDataTextColumn>

                                        <dx:GridViewDataTextColumn Caption="Navigateur" FieldName="NAVIGATEUR" 
                                            VisibleIndex="8">
                                        </dx:GridViewDataTextColumn>

                                        <dx:GridViewDataTextColumn Caption="Nom de la machine" FieldName="NOMMACHINE" 
                                            VisibleIndex="9">
                                        </dx:GridViewDataTextColumn>

                                        <dx:GridViewDataTextColumn Caption="Exercice" FieldName="EXERCICE" Visible = "false" 
                                            VisibleIndex="10">
                                        </dx:GridViewDataTextColumn>

                                        <dx:GridViewDataTextColumn Caption="Site id" FieldName="SITE_ID" Visible = "false"
                                            VisibleIndex="11">
                                        </dx:GridViewDataTextColumn>

                                        <dx:GridViewDataTextColumn Caption="Statut" FieldName="STATUTCONNECT" Visible = "false"
                                            VisibleIndex="12">
                                        </dx:GridViewDataTextColumn>
