...
<asp:Content ID="Content5" ContentPlaceHolderID="PageContent" runat="server">
    <dx:ASPxGridView runat="server" ID="MainGridView" ClientInstanceName="gridView"
        KeyFieldName="ID_MENU" EnablePagingGestures="False" CssClass="grid-view" Width="100%"
        DataSourceID="MainGridViewDataSource" AutoGenerateColumns="False">
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="Code" FieldName="CODE_MENU" Width="10%">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Intitulé" FieldName="LIBELLE_MENU" Width="65%">
                <EditItemTemplate>
                    <dx:ASPxTextBox runat="server" ID="txtLibelle" Value='<%# Bind("LIBELLE_MENU") %>' ValidationSettings-ValidationGroup="<%# Container.ValidationGroup %>">
        ...
        <EditFormLayoutProperties UseDefaultPaddings="false">
            ...
            <Items>
                <dx:GridViewLayoutGroup ColCount="2" GroupBoxDecoration="None">
                    <Items>
                        <dx:GridViewColumnLayoutItem ColumnName="CODE_MENU" Caption="Code" />
                        <dx:GridViewColumnLayoutItem ColumnName="LIBELLE_MENU" Caption="Libellé" ColumnSpan="2" />
    ...
    <asp:SqlDataSource ID="MainGridViewDataSource" runat="server"
        ...
        InsertCommand="PS_E_MENU" InsertCommandType="StoredProcedure"
        UpdateCommand="PS_E_MENU" UpdateCommandType="StoredProcedure"
        DeleteCommand="PS_E_MENU" DeleteCommandType="StoredProcedure">
        ...
        <InsertParameters>
            ...
            <asp:Parameter Name="CODE_MENU" Type="String" />
            <asp:Parameter Name="LIBELLE_MENU" Type="String" />
