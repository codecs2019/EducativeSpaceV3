...
namespace JfrSystems.Model
{
    ...
    public static class SchedulerLabelsHelper
    {
        ...
        static SchedulerLabelsHelper()
        {
            ...
            items.Add(new SchedulerLabel { Id = 1, Name = "Confirmer", Color = System.Drawing.Color.DarkBlue });
            items.Add(new SchedulerLabel { Id = 2, Name = "Reporter", Color = System.Drawing.Color.Blue });
            items.Add(new SchedulerLabel { Id = 3, Name = "Annuler", Color = System.Drawing.Color.SkyBlue });
            items.Add(new SchedulerLabel { Id = 4, Name = "Attente", Color = System.Drawing.Color.SkyBlue });
        }
    ...
    {
        public string PlanAnaly { get; set; }
